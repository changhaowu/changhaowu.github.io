---
layout: post
title: "How-the-Domestic-Economics-Machine-Works-Practice"
date: 2024-06-23
...
- **Irrational Debt in the Private Sector**: The significant increase in housing prices over the past decade has led to substantial inflation of credit within the sector, pushing market dynamics to deviate from the nationwide Return on Assets (ROA) level.
...
On the brokage of the real estate crisis in China, the demand for Mortgage backed securities (the real estates debt) from bank vanishes, forcing banks to hold long-term housing debt from the private sector.  
...
- **Housing Prices**: Heavily influenced by buyer income levels and expectations, as well as the nationwide ROA level. Current ROA of real estate in Chinese large cities is unattrative, compared to the government bond yields.
- **Government Bond Yields**: Serve as the benchmark for overall asset yields. When housing yields fall below government bond yields, the attractiveness of real estate investment decreases, which is supported by the mature real estate market performance.
- **Future Return of Asset**: The future return of the asset is estimated by considering the change in price and the income of renters in the future, it really a mind experiment, as we have no idea about the future.


#### Analysis on Current ROA of Real Estate
...
- Real estate:
  - the real estate in China is considered as the most profitable asset in the nation, with the highest annual payback rate in the past era
...
- Gross ROA (2019, 2024): Approximately 4.97% in 2019 and 5.83% in 2024 for NYC; around 5.74% in 2019 and 5.95% in 2024 for SF [(numbeo)](https://www.numbeo.com/property-investment/compare_cities.jsp?country1=Japan&city1=Tokyo&country2=United+States&city2=New+York%2C+NY)
- Property Tax Rate: 0.88% for NYC, 0.76% for SF [(CooperatorNews)](https://cooperatornews.com/article/to-rentor-buy).
- Rental Income Tax Rate: Estimated at 15%.
- 10-Year Bond Yield: U.S. yields of 2.00% in 2019 and 4.20% in 2024 [(CooperatorNews)](https://cooperatornews.com/article/to-rentor-buy).
- Bond Yield (Post-Tax): Adjusted for 15% tax rate.

Tokyo
- Gross ROA (2019, 2024): About 2.45% in 2019 and 3.03% in 2024 [(numbeo)](https://www.numbeo.com/property-investment/compare_cities.jsp?country1=Japan&city1=Tokyo&country2=United+States&city2=New+York%2C+NY).
- Property Tax Rate: 1.4% [(numbeo)](https://www.numbeo.com/property-investment/compare_cities.jsp?country1=Japan&city1=Tokyo&country2=United+States&city2=New+York%2C+NY).
- Rental Income Tax Rate: Estimated at 20.4%.
- 10-Year Bond Yield: Japan yields of -0.14% in 2019 and 0.25% in 2024 [(numbeo)](https://www.numbeo.com/property-investment/compare_cities.jsp?country1=Japan&city1=Tokyo&country2=United+States&city2=New+York%2C+NY).
- Bond Yield (Post-Tax): Adjusted for 20.315% tax rate.

Shanghai
- Gross ROA (2019, 2024): About 1.69% in 2019 and 1.65% in 2024 [(CEIC Data)](https://www.ceicdata.com/en/china/nbs-property-price-monthly/property-price-ytd-avg-shanghai).
- Property Tax Rate: Included in the property price.
- Rental Income Tax Rate: Estimated at 3.5%.
- 10-Year Bond Yield: China yields of 3.20% in 2019 and 2.35% in 2024 [(China Bond)](https://yield.chinabond.com.cn/cbweb-pbc-web/pbc/more?locale=en_US).
- Bond Yield (Post-Tax): Exempt from tax.
...
- Gross ROA: 4.97%
- Property Tax: 0.88%
- Rental Income Tax: (4.97% - 0.88%) * 15% = 0.6145%
...
This table provides a comparison of the ROA, adjusted for property and rental income taxes, as well as the 10-year bond yields and their post-tax values in New York City, San Francisco, Tokyo, and Shanghai for the years 2019 and 2024. To conclude:

From current ROA persepective: If we exclude future price debt, focusing solely on the ROA aspect of the asset, housing temporarily is not a clever asset for the private sector. The adjusted yield of Chinese treasury bonds is still higher than the ROA of housing. Compared to mature real estate markets, the ROA of housing should be higher.
  



#### Analysis on Future ROA of Real Estate

Upon the analysis, we use the static model to analyze the future trend of the housing market in China. The all factors that we consider is the in the current timestamp, and now we can try a mind experiment, 
we still focus on the ROA perspective, while we will dynamics try to estimate the return of the asset in the future.

To analyze the return of the asset, we will then consider the change of price, also the income of the renters in the future. From the perspective of these factors that influence the future growth rate of house prices:
Who needs the real estate as an asset?
...
- **Government-led Marketization**: Increasing role of the government in the economy.
- **New Quality Productivity Dilemma**: Challenges in emerging sectors like new energy under the backdrop of de-globalization.

#### Recommendations for Transformation
- **Enhance Market Mechanisms**: Reduce government intervention and promote market regulation.
- **Expand International Cooperation**: Seek international market opportunities in emerging sectors.
- **Evaluate Long-term Effects**: Continuously monitor the economic pull of sectors like new energy.

### Financial Regulation

#### Challenges in Financial Regulation
- **Debt Management and Asset Yield**: Short-term effects and long-term risks of the strategy of rolling over old debts with new debts.

#### Recommendations for Financial Regulation
- **Improve Debt Management Mechanisms**: Reduce reliance on short-term borrowing.
- **Optimize Asset Allocation**: Direct financial resources to projects with long-term yield potential.

### Flexible Forex Policies

#### Challenges in Forex Policies
- **Requirements of RMB Internationalization**: Increasing difficulty in maintaining exchange rate stability.

#### Recommendations for Forex Policies
- **Optimize Forex Control Measures**: Address challenges of international capital flows.
- **Promote RMB Internationalization**: Strengthen economic cooperation with major trading partners.
...
### Limitations of Current Economic Policies
- **Temporary Measures**: Limited effectiveness of short-term policy measures.
- **Long-term Risks**: Potential systemic risks and long-term challenges.

### Necessity of Systemic Reforms
- **Comprehensive Use of Policy Tools**: Systemic reforms and adjustments are needed to address long-term economic issues.
- **Future Outlook**: Long-term economic prospects under the current framework.
